...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{% static " rest_framework
    ...
    <div class="container">
        ...
        <div id="content">
            ...
            <div class="content-main">
              ...
              <pre class="prettyprint"><span class="meta nocode"><b>HTTP {{ response.status_code }} {{
                  response.status_text }}</b>{% autoescape off %}
...
{% block script %}
<script src="{% static " rest_framework
